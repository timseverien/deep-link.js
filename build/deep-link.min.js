 ...
 */
function(){"use strict";for(var i=1200,t={android:{store_prefix:"https://play.google.com/store/apps/details?id=",test:/Android/i},iOS:{store_prefix:"https://itunes.apple.com/en/app/id",test:/iPhone|iPad|iPod/i}},e=function(){var i;for(i in t)if(navigator.userAgent.match(t[i].test))return i;return""},n=function(){return(new Date).getTime()},s=function(i){window.location.href=i},a=function(a){var o,r,c=e(),h=c.toLowerCase(),l=a.getAttribute("href"),d=a.getAttribute("data-app-"+h)||a.getAttribute("data-app"),u=a.getAttribute("data-store-"+h)||a.getAttribute("data-store");d&&(l||a.setAttribute("href",d),c&&d?a.onclick=function(e){e.preventDefault(),e.stopImmediatePropagation();var a,h=n();o=!0,r=setTimeout(function(){if(o&&r){var e=n();o=!1,r=null,e-h>=2*i||(u?s(t[c].store_prefix+u):l&&s(l))}},i),a=s(d)}:l&&"#"!==l||(a.style.display="none"),visibly.onHidden(function(){o&&r&&(r=clearInterval(r),o=!1)}))},o=document.getElementsByTagName("a"),r=o.length;r--;)a(o[r])}();